...
import { IsNoteLoggedAdmin, IsNoteLoggedUser } from '../protectedRoutes/protectedRoute';
    ...
    return (
        <Suspense fallback={<Imports.Loader />}>
            <Imports.Routes>
                ...
                <Imports.Route element={<IsNoteLoggedUser />}>
                    <Imports.Route path={Imports.Path.Login} element={<Imports.Login />} />
                </Imports.Route>

                <Imports.Route element={<IsNoteLoggedAdmin />}>
