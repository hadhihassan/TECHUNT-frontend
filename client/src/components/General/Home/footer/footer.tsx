...
const footer = () => {
    return (
        ...
        <footer className="bg-stone-900 dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between h-auto">
                    <div className="mb-6 md:mb-0">
                        <span className="text-red-500 sx:text-3xl text-2xl font-extrabold font-montserrat break-words ">TECH</span>
                        <span className="text-red-500 sx:text-3xl text-2xl font-normal font-montserrat break-words">UNT</span>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-4 sm:grid-cols-4">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-gray-400">For clients</h2>
                            <ul className="text-gray-300 dark:text-gray-400 font-normal">
                                <li className="mb-2"><Link to={'/'}>Hire Worldwide</Link></li>
                                <li className="mb-2"><Link to={'/'}>Hire in the USA</Link></li>
                                <li className="mb-2"><Link to={'/'}>How to Hire</Link></li>
                                <li className="mb-2"><Link to={'/'}>Talent Marketplace</Link></li>
                                <li className="mb-2"><Link to={'/'}>Project Catalog</Link></li>
                                <li className="mb-2"><Link to={'/'}>Talent Scout</Link></li>
                                <li className="mb-2"><Link to={'/'}>Enterprise</Link></li>
                                <li className="mb-2"><Link to={'/'}>Payroll Services</Link></li>
                                <li className="mb-2"><Link to={'/'}>Direct Contracts</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-gray-400">For Talent</h2>
                            <ul className="text-gray-300 dark:text-gray-400 font-normal">
                                <li ><Link to={'/'}>How to Find Work</Link></li>
                                <li ><Link to={'/'}>Direct Contracts</Link></li>
                                <li ><Link to={'/'}>Find Freelance Jobs Worldwide</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-gray-400">Help & Support</h2>
                            <ul className="text-gray-300 dark:text-gray-400 font-normal">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-gray-400">About Us</h2>
                            <ul className="text-gray-300 dark:text-gray-400 font-normal">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">TechHunt™</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a href="#" className="text-gray-300 hover:text-white dark:hover:text-white ms-5">
