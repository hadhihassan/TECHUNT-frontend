    ...
    export function ListAllPlans() {
        ...
        const [editIndex, setIndex] = useState<number>(0)
        ...
        const slicedPlans = filteredPlans.slice(indexOfFirstPost, indexOfLastPost);
                    ...
                    <CardHeader floated={false} shadow={false} className="rounded-none flex justify-between items-center" placeholder={undefined}>
                        ...
                        <div className="mb-8 flex items-center justify-between gap-8 mr-5">
                            <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                                ...
                                {
                                    editOpen && <EditPlanForm isOpen={editOpen} closeModal={closeEdit} data={editData} editData={plans[editIndex]} />
                                }
                            </div>
                        </div>
                    </CardHeader>
