...
const DataTable = () => {
    ...
    const { getTableProps, getTableBodyProps, headerGroups, prepareRow, page, nextPage, previousPage, canNextPage,
        canPreviousPage, pageOptions, state, setGlobalFilter, } = useTable({
            columns, data: switchUser ? data1 : data, initialState: { pageIndex: 0 }
        },
            useFilters,
            useGlobalFilter,
            useSortBy,
