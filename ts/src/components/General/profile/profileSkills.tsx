    ...
    return (
        <div className="w-[22rem] h-auto rounded-2xl border shadow-xl">
            <div className="flex justify-between">
                ...
                <button onClick={openModal} className="w-[5rem] mt-3 mr-2 font-sans font-medium rounded-full h-7 border border-red-500 text-red-500">{viewSkills.length ? "Edit" : "Add"}</button>
            </div>
            ...
            <p className="mt-4 text-blue-500 text-center m-2 hover:cursor-pointer" onClick={() => setShowAll(!show)}>View All</p>
        </div>
    )
}
