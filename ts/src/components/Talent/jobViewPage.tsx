...
import { JobInterface } from '../../interface/loginSliceType'
const JobViewPage = () => {
                    ...
                    <div className=" w-[100%] flex  h-full">
                        ...
                        <div className="sm:w-[25%]">
                            <div className="w-full  font-sans flex flex-col">
                                <button className="bg-red-500 border mt-5 rounded-full py-2 text-white font-semibold">Submit propsoal</button>
