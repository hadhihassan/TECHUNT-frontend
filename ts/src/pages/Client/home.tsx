            ...
            <div className=" flex w-full ">
                ...
                <div className=" ml-10 w-[30vw] mt-5">
                    ...
                    <div className="border  shadow-xl w-[80%] rounded-xl h-auto" ref={ref1}>
                        ...
                        <p
                            className="font-sans font-thin text-xs text-slate-500 mt-2 text-center mb-2">
                                    ...
                                    <Disclosure.Panel>
                                        <div className="border  shadow-xl w-[80%] rounded-xl h-auto mb-5  mt-2 ">
                                            <div className="w-full border-b-2 mt-5  flex justify-between">
                                                ...
                                                <p className="m-2 font-sans font-semibold text-md mb-1">Total :<b className="font-sans font-semibold text-md mb-1">30</b> </p>
                                            </div>
                                            <div className="flex justify-between m-5 ">
                                                <div className="flex">
                                                    ...
                                                    <span className=" ml-2 hover:text-red-500 text-sm">: 01</span>
                                                </div>
                                            </div>
                                            <div className="flex justify-between m-5 ">
                                                <div className="flex">
