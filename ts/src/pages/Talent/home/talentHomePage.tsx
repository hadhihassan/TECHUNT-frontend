...
const HomePage = () => {
    ...
    const handleShowDeatilsView: (index: number) => void = (index) => {
            ...
            <>
                ...
                <div className=" sm:flex w-full">
                    ...
                    <div className="flex flex-col mt-5 ml-28 w-[60%] ">
                        ...
                        {/* filter */}
                        {
                            posts.map((post: Project, _index: number) => (
                                <div className="w-full mt-5" key={_index} onClick={() => handleShowDeatilsView(_index)}>
                    ...
                    <div className="ml-10 w-[30vw] mt-9">
                        ...
                        {/* verifications */}
                        <div className="border bg-white shadow-xl w-[80%] rounded-xl h-[38vh] mt-6 ">
                        ...
                        {/* Jobs */}
                        <div className="border bg-white  shadow-xl w-[80%] rounded-xl h-[40vh] mt-6 ">
