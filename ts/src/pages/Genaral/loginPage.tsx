...
import { INITIALSTATE, setEmail } from "../../redux/Slice/loginSlice";
...
const Login = () => {
    ...
    const data: INITIALSTATE = useSelector((state: ROOTSTORE) => state.login);
    useDispatch()
    console.log(data)
    const handleEmailSubmit = (event: React.FormEvent) => {
        ...
        axios.post('http://localhost:3000/signup/', { email: inputvalue })
            .then((res) => {
                console.log(res);
            })
            .catch((err) => {
    ...
    return (
        <div>
            ...
            <div className="w-full flex flex-col justify-center items-center">
                {message ?
                    <div className="w-[35rem] h-[30px] top-6 flex   relative bg-stone-200 shadow rounded-xl" >
                ...
                <div className="w-[40rem] flex space-y-14 items-center flex-col   h-[40rem] mt-16 mb-16  border shadow-2xl rounded-lg">
                    ...
                    <div className="w-[460px] h-[55.31px] bg-indigo-600 rounded-[100px]" >
                        <p className="text-white text-center mt-4">Continue with Google</p>
                    </div>
                    ...
                    <div className="w-[460px] h-[55.31px] " >
                        ...
                        <p className="text-zinc-950 text-xs mt-14 text-center font-normal font-sans">
